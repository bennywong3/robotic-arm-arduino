...
#define END_EFFECTOR_OFFSET 45.0 // LENGTH FROM UPPER SHANK BEARING TO MIDPOINT OF END EFFECTOR IN MM
...
#define Z_HOME_STEPS 1820 //3640 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER
